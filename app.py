...
with st.sidebar:
    ...
    # Definir as categorias com seus itens
    CATEGORIAS = {
    ...
    # Lista plana de itens (APENAS OS NOMES, sem categoria)
    TODOS_ITENS = []
    ...
    # Renderizar cabeçalhos das categorias
    for categoria, itens in CATEGORIAS.items():
    ...
    # Radio com APENAS os nomes dos itens (sem a categoria)
    selected = st.radio(
        "Navegação",
        options=TODOS_ITENS,
